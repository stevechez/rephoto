				...
				<div>
					<div className="flex items-center justify-between py-3 md:py-5 md:block">
						<Link href="/" className="mt-12 md:mt-0">
							<img
								src="/images/rephoto-logo.png"
								width={360}
								height={200}
								alt="Strata Visual - real estate marketing"
							/>
						</Link>
					...
					>
						<ul className="space-y-2 md:flex md:space-x-6 md:space-y-0 mt-0 md:mt-14">
							<li className="text-black hover:text-blue-600">
								<Link
									href="/about"
									className="hover:text-blue-500 tracking-wider"
								>
									About
								</Link>
							</li>
							<li className="hover:text-blue-500 tracking-wider">
								<Menu>
